...
import (
	...
	"github.com/zerotraceio/zerotrace/server/controller/cloud/aliyun"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/aws"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/baidubce"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/config"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/filereader"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/genesis"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/huawei"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/kubernetes"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/model"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/qingcloud"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/tencent"
	"github.com/zerotraceio/zerotrace/server/controller/cloud/volcengine"
