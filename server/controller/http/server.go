...
import (
	...
	"github.com/zerotraceio/zerotrace/server/controller/http/appender"
	"github.com/zerotraceio/zerotrace/server/controller/http/common/registrant"
	"github.com/zerotraceio/zerotrace/server/controller/http/router"
	"github.com/zerotraceio/zerotrace/server/controller/http/router/agent"
	"github.com/zerotraceio/zerotrace/server/controller/http/router/resource"
	"github.com/zerotraceio/zerotrace/server/controller/http/router/vtap"
	"github.com/zerotraceio/zerotrace/server/controller/manager"
	"github.com/zerotraceio/zerotrace/server/controller/monitor"
	trouter "github.com/zerotraceio/zerotrace/server/controller/trisolaris/server/http"
