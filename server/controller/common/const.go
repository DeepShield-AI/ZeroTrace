...
const (
	VTAP_OWNER_ZEROTRACE = "zerotrace"
)
...
const (
	NODE_NAME_KEY    = "K8S_NODE_NAME_FOR_ZEROTRACE"
	NODE_IP_KEY      = "K8S_NODE_IP_FOR_ZEROTRACE"
	POD_NAME_KEY     = "K8S_POD_NAME_FOR_ZEROTRACE"
	POD_IP_KEY       = "K8S_POD_IP_FOR_ZEROTRACE"
	NAME_SPACE_KEY   = "K8S_NAMESPACE_FOR_ZEROTRACE"
	RUNNING_MODE_KEY = "ZEROTRACE_SERVER_RUNNING_MODE"
)
...
const (
	DATA_SOURCE_ZEROTRACE_SYSTEM_INTERVAL = 10
)
