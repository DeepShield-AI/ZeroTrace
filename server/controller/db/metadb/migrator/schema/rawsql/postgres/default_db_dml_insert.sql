...
VALUES (
    1, 1, '过滤项: N/A | 分组项: tag.host_ip, tag.path, tag.host', '[{"type":"zerotrace","tableName":"zerotrace_server_monitor_disk","dbName":"zerotrace_admin","metrics":[{"description":"","typeName":"counter","METRIC_CATEGORY":"metrics","METRIC":"metrics.used_percent","METRIC_NAME":"metrics.used_percent","isTimeUnit":false,"type":1,"unit":"","cascaderLabel":"metrics.free","display_name":"--","hasDerivative":false,"isPrometheus":false,"operatorLv2":[],"operatorLv1":"Last","perOperator":"","METRIC_LABEL":"disk_used_percent","checked":true,"percentile":null,"_key":"561bf802-10ae-4988-38f5-97001e896d8e","markLine":null,"ORIGIN_METRIC_LABEL":"Last(metrics.used_percent)"}],"dataSource":"","condition":{"dbName":"zerotrace_admin","tableName":"zerotrace_server_monitor_disk","type":"simplified","RESOURCE_SETS":[{"id":"R1","condition":[],"groupBy":["_","tag.host","tag.host_ip","tag.path"],"groupInfo":{"mainGroupInfo":["_"],"otherGroupInfo":["tag.host","tag.host_ip","tag.path"]},"inputMode":"free"}]}}]', '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_monitor_disk","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Last(`metrics.used_percent`) AS `disk_used_percent`","WHERE":"1=1","GROUP_BY":"`tag.host_ip`, `tag.path`, `tag.host`","METRICS":["Last(`metrics.used_percent`) AS `disk_used_percent`"]}]}', '[{"METRIC_LABEL":"disk_used_percent","return_field_description":"磁盘用量百分比","unit":"%"}]', '控制器磁盘空间不足', 0, 1, 1, 21, 1, '', '', '{"displayName":"disk_used_percent", "unit": "%"}', '{"OP":">=","VALUE":70}', gen_random_uuid());
...
VALUES (
    ...
    '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_monitor_disk","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Last(`metrics.used_percent`) AS `disk_used_percent`","WHERE":"1=1","GROUP_BY":"`tag.host_ip`, `tag.path`, `tag.host`","METRICS":["Last(`metrics.used_percent`) AS `disk_used_percent`"]}]}' ,
...
INSERT INTO alarm_policy (
    ...
    threshold_warning, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: tag.host, tag.db, tag.table, tag.partition', '[{"type":"zerotrace","tableName":"zerotrace_server_ingester_force_delete_clickhouse_data","dbName":"zerotrace_admin","metrics":[{"description":"","typeName":"counter","METRIC_CATEGORY":"metrics","METRIC":"metrics.bytes_on_disk","METRIC_NAME":"metrics.bytes_on_disk","isTimeUnit":false,"type":1,"unit":"","cascaderLabel":"metrics.bytes_on_disk","display_name":"--","hasDerivative":false,"isPrometheus":false,"operatorLv2":[],"operatorLv1":"Sum","perOperator":"","METRIC_LABEL":"force_delete_clickhouse_data_bytes_on_disk","checked":true,"percentile":null,"_key":"789ba080-5a52-11ad-25ae-097318b21194","markLine":null,"ORIGIN_METRIC_LABEL":"Sum(metrics.bytes_on_disk)"}],"dataSource":"","condition":{"dbName":"zerotrace_admin","tableName":"zerotrace_server_ingester_force_delete_clickhouse_data","type":"simplified","RESOURCE_SETS":[{"id":"R1","condition":[],"groupBy":["_","tag.host","tag.db","tag.partition","tag.table"],"groupInfo":{"mainGroupInfo":["_"],"otherGroupInfo":["tag.host","tag.db","tag.partition","tag.table"]},"inputMode":"free"}]}}]',
    '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_ingester_force_delete_clickhouse_data","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Sum(`metrics.bytes_on_disk`) AS `force_delete_clickhouse_data_bytes_on_disk`","WHERE":"1=1","GROUP_BY":"`tag.host`, `tag.db`, `tag.table`, `tag.partition`","METRICS":["Sum(`metrics.bytes_on_disk`) AS `force_delete_clickhouse_data_bytes_on_disk`"]}]}' ,
...
INSERT INTO alarm_policy (
    ...
    threshold_warning, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: tag.host', '[{"type":"zerotrace","tableName":"zerotrace_server_ingester_recviver","dbName":"zerotrace_admin","metrics":[{"description":"","typeName":"counter","METRIC_CATEGORY":"metrics","METRIC":"metrics.invalid","METRIC_NAME":"metrics.invalid","isTimeUnit":false,"type":1,"unit":"","checked":true,"operatorLv2":[],"_key":"2dfe0af2-b363-95b9-f8ce-acd3e9f0f567","perOperator":"","operatorLv1":"Sum","percentile":null,"markLine":null,"METRIC_LABEL":"ingester.recviver.metrics.invalid","ORIGIN_METRIC_LABEL":"Sum(metrics.invalid)"}],"dataSource":"","condition":{"dbName":"zerotrace_admin","tableName":"zerotrace_server_ingester_recviver","type":"simplified","RESOURCE_SETS":[{"id":"R1","condition":[],"groupBy":["_","tag.host"],"groupInfo":{"mainGroupInfo":["_"],"otherGroupInfo":["tag.host"]},"inputMode":"free"}]}}]',
    '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_ingester_recviver","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Sum(`metrics.invalid`) AS `ingester.recviver.metrics.invalid`","WHERE":"1=1","GROUP_BY":"`tag.host`","METRICS":["Sum(`metrics.invalid`) AS `ingester.recviver.metrics.invalid`"]}]}' ,
...
INSERT INTO alarm_policy (
    ...
    threshold_warning, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: tag.host, tag.module', '[{"type":"zerotrace","tableName":"zerotrace_server_ingester_queue","dbName":"zerotrace_admin","metrics":[{"description":"","typeName":"counter","METRIC_CATEGORY":"metrics","METRIC":"metrics.overwritten","METRIC_NAME":"metrics.overwritten","isTimeUnit":false,"type":1,"unit":"","cascaderLabel":"metrics.in","display_name":"--","hasDerivative":false,"isPrometheus":false,"operatorLv2":[],"operatorLv1":"Sum","perOperator":"","METRIC_LABEL":"ingester.queue.metrics.overwritten","checked":true,"percentile":null,"_key":"e3554a5e-ec69-abe7-2c94-a5000578c23a","markLine":null,"ORIGIN_METRIC_LABEL":"Sum(metrics.overwritten)"}],"dataSource":"","condition":{"dbName":"zerotrace_admin","tableName":"zerotrace_server_ingester_queue","type":"simplified","RESOURCE_SETS":[{"id":"R1","condition":[],"groupBy":["_","tag.host","tag.module"],"groupInfo":{"mainGroupInfo":["_"],"otherGroupInfo":["tag.host","tag.module"]},"inputMode":"free"}]}}]',
    '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_ingester_queue","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Sum(`metrics.overwritten`) AS `ingester.queue.metrics.overwritten`","WHERE":"1=1","GROUP_BY":"`tag.host`, `tag.module`","METRICS":["Sum(`metrics.overwritten`) AS `ingester.queue.metrics.overwritten`"]}]}' ,
...
INSERT INTO alarm_policy (
    ...
    threshold_warning, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: tag.host', '[{"type":"zerotrace","tableName":"zerotrace_server_ingester_decoder","dbName":"zerotrace_admin","metrics":[{"description":"","typeName":"counter","METRIC_CATEGORY":"metrics","METRIC":"metrics.drop_count","METRIC_NAME":"metrics.drop_count","isTimeUnit":false,"type":1,"unit":"","cascaderLabel":"metrics.avg_time","display_name":"--","hasDerivative":false,"isPrometheus":false,"operatorLv2":[],"operatorLv1":"Sum","perOperator":"","METRIC_LABEL":"ingester.decoder.metrics.drop_count","checked":true,"percentile":null,"_key":"3c32775e-72b5-a62c-c97d-b90bdf049923","markLine":null,"ORIGIN_METRIC_LABEL":"Sum(metrics.drop_count)"}],"dataSource":"","condition":{"dbName":"zerotrace_admin","tableName":"zerotrace_server_ingester_decoder","type":"simplified","RESOURCE_SETS":[{"id":"R1","condition":[],"groupBy":["_","tag.host"],"groupInfo":{"mainGroupInfo":["_"],"otherGroupInfo":["tag.host"]},"inputMode":"free"}]}}]',
    '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_ingester_decoder","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Sum(`metrics.drop_count`) AS `ingester.decoder.metrics.drop_count`","WHERE":"1=1","GROUP_BY":"`tag.host`","METRICS":["Sum(`metrics.drop_count`) AS `ingester.decoder.metrics.drop_count`"]}]}' ,
...
INSERT INTO alarm_policy (
    ...
    threshold_warning, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: tag.host', '[{"type":"zerotrace","tableName":"zerotrace_server_ingester_ckwriter","dbName":"zerotrace_admin","metrics":[{"description":"","typeName":"counter","METRIC_CATEGORY":"metrics","METRIC":"metrics.write_failed_count","METRIC_NAME":"metrics.write_failed_count","isTimeUnit":false,"type":1,"unit":"","cascaderLabel":"metrics.org_invalid_count","display_name":"--","hasDerivative":false,"isPrometheus":false,"operatorLv2":[],"operatorLv1":"Sum","perOperator":"","METRIC_LABEL":"ingester.ckwriter.metrics.write_failed_count","checked":true,"percentile":null,"_key":"14090ba1-13b7-97eb-de89-a141e06afc89","markLine":null,"ORIGIN_METRIC_LABEL":"Sum(metrics.write_failed_count)"}],"dataSource":"","condition":{"dbName":"zerotrace_admin","tableName":"zerotrace_server_ingester_ckwriter","type":"simplified","RESOURCE_SETS":[{"id":"R1","condition":[],"groupBy":["_","tag.host"],"groupInfo":{"mainGroupInfo":["_"],"otherGroupInfo":["tag.host"]},"inputMode":"free"}]}}]',
    '/v1/stats/querier/UniversalHistory', '{"DATABASE":"zerotrace_admin","TABLE":"zerotrace_server_ingester_ckwriter","interval":60,"fill": "none","window_size":1,"QUERIES":[{"QUERY_ID":"R1","SELECT":"Sum(`metrics.write_failed_count`) AS `ingester.ckwriter.metrics.write_failed_count`","WHERE":"1=1","GROUP_BY":"`tag.host`","METRICS":["Sum(`metrics.write_failed_count`) AS `ingester.ckwriter.metrics.write_failed_count`"]}]}' ,
...
INSERT INTO alarm_policy (
    ...
    threshold_error, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/voucher-30days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "余额预估可用天数", "return_field_unit": "天"}}]', 'ZeroTrace 服务即将停止', 1, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":30}', gen_random_uuid());
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/voucher-0days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "余额可用天数", "return_field_unit": "天"}}]', 'ZeroTrace 服务停止', 2, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":0}', gen_random_uuid());
...
INSERT INTO alarm_policy (
    ...
    threshold_error, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/license-30days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "至少一个授权文件剩余有效期", "return_field_unit": "天"}}]', 'ZeroTrace 授权即将过期', 1, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":30}', gen_random_uuid());
...
INSERT INTO alarm_policy (
    ...
    threshold_critical, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/license-0days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "至少一个授权文件剩余有效期", "return_field_unit": "天"}}]', 'ZeroTrace 授权过期', 2, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":0}', gen_random_uuid());
...
VALUES ('管理侧监控数据', 'zerotrace_admin.*', 0, 7*24, gen_random_uuid());
