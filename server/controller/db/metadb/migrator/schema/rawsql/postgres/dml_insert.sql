...
INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (12, '租户侧监控数据', 'zerotrace_tenant.*', 0, 7 * 24, gen_random_uuid());
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: host', '', '/v1/stats/querier/UniversalPromHistory', '{"DATABASE":"","PROM_SQL":"delta(min(zerotrace_tenant__zerotrace_agent_monitor__create_time)by(host)[1m:10s])","interval":60,"metric":"process_start_time_delta","time_tag":"toi"}',
