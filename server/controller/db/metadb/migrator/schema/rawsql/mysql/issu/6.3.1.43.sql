...
UPDATE alarm_policy SET query_params="{\"DATABASE\":\"zerotrace_system\",\"TABLE\":\"zerotrace_agent_dispatcher\",\"interval\":60,\"fill\": \"none\",\"window_size\":1,\"QUERIES\":[{\"QUERY_ID\":\"R1\",\"SELECT\":\"Sum(`metrics.err`) AS `drop_packets`\",\"WHERE\":\"1=1\",\"GROUP_BY\":\"`tag.host`\",\"METRICS\":[\"Sum(`metrics.err`) AS `drop_packets`\"]}]}" WHERE name="采集器数据丢失 (dispatcher.metrics.err)";
...
UPDATE alarm_policy SET query_params="{\"DATABASE\":\"zerotrace_system\",\"TABLE\":\"zerotrace_agent_quadruple_generator\",\"interval\":60,\"fill\": \"none\",\"window_size\":1,\"QUERIES\":[{\"QUERY_ID\":\"R1\",\"SELECT\":\"Sum(`metrics.drop-before-window`) AS `drop_packets`\",\"WHERE\":\"1=1\",\"GROUP_BY\":\"`tag.host`\",\"METRICS\":[\"Sum(`metrics.drop-before-window`) AS `drop_packets`\"]}]}" WHERE name="采集器数据丢失 (quadruple_generator.metrics.drop-before-window)";
