...
UPDATE alarm_policy SET sub_view_params="{\"DATABASE\":\"zerotrace_system\",\"TABLE\":\"zerotrace_agent_dispatcher\",\"interval\":60,\"fill\":0,\"window_size\":1,\"QUERIES\":[{\"QUERY_ID\":\"R1\",\"SELECT\":\"Sum(`metrics.kernel_drops`) AS `drop_packets`\",\"WHERE\":\"1=1\",\"GROUP_BY\":\"`tag.host`\",\"METRICS\":[\"Sum(`metrics.kernel_drops`) AS `drop_packets`\"]}]}" WHERE name="采集器丢包(dispatcher)";

UPDATE alarm_policy SET sub_view_params="{\"DATABASE\":\"zerotrace_system\",\"TABLE\":\"zerotrace_agent_queue\",\"interval\":60,\"fill\":0,\"window_size\":1,\"QUERIES\":[{\"QUERY_ID\":\"R1\",\"SELECT\":\"Sum(`metrics.overwritten`) AS `drop_packets`\",\"WHERE\":\"1=1\",\"GROUP_BY\":\"`tag.host`\",\"METRICS\":[\"Sum(`metrics.overwritten`) AS `drop_packets`\"]}]}" WHERE name="采集器丢包(queue)";
