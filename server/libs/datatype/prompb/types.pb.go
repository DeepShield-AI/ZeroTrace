...
type MetricMetadata struct {
	...
	Type                 MetricMetadata_MetricType `protobuf:"varint,1,opt,name=type,proto3,enum=prometheus_zerotrace.MetricMetadata_MetricType" json:"type,omitempty"`
...
type Histogram struct {
	...
	ResetHint      Histogram_ResetHint `protobuf:"varint,14,opt,name=reset_hint,json=resetHint,proto3,enum=prometheus_zerotrace.Histogram_ResetHint" json:"reset_hint,omitempty"`
	// timestamp is in ms format, see model/timestamp/timestamp.go for
	// conversion from time.Time to Prometheus timestamp.
...
type LabelMatcher struct {
	Type                 LabelMatcher_Type `protobuf:"varint,1,opt,name=type,proto3,enum=prometheus_zerotrace.LabelMatcher_Type" json:"type,omitempty"`
...
type Chunk struct {
	...
	Type                 Chunk_Encoding `protobuf:"varint,3,opt,name=type,proto3,enum=prometheus_zerotrace.Chunk_Encoding" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("prometheus_zerotrace.MetricMetadata_MetricType", MetricMetadata_MetricType_name, MetricMetadata_MetricType_value)
	proto.RegisterEnum("prometheus_zerotrace.Histogram_ResetHint", Histogram_ResetHint_name, Histogram_ResetHint_value)
	proto.RegisterEnum("prometheus_zerotrace.LabelMatcher_Type", LabelMatcher_Type_name, LabelMatcher_Type_value)
	proto.RegisterEnum("prometheus_zerotrace.Chunk_Encoding", Chunk_Encoding_name, Chunk_Encoding_value)
	proto.RegisterType((*MetricMetadata)(nil), "prometheus_zerotrace.MetricMetadata")
	proto.RegisterType((*Sample)(nil), "prometheus_zerotrace.Sample")
	proto.RegisterType((*Exemplar)(nil), "prometheus_zerotrace.Exemplar")
	proto.RegisterType((*Histogram)(nil), "prometheus_zerotrace.Histogram")
	proto.RegisterType((*BucketSpan)(nil), "prometheus_zerotrace.BucketSpan")
	proto.RegisterType((*TimeSeries)(nil), "prometheus_zerotrace.TimeSeries")
	proto.RegisterType((*Label)(nil), "prometheus_zerotrace.Label")
	proto.RegisterType((*Labels)(nil), "prometheus_zerotrace.Labels")
	proto.RegisterType((*LabelMatcher)(nil), "prometheus_zerotrace.LabelMatcher")
	proto.RegisterType((*ReadHints)(nil), "prometheus_zerotrace.ReadHints")
	proto.RegisterType((*Chunk)(nil), "prometheus_zerotrace.Chunk")
	proto.RegisterType((*ChunkedSeries)(nil), "prometheus_zerotrace.ChunkedSeries")
}
