...
詳細については、[ドキュメントサイト](https://zerotrace.io/docs/?from=github)をご覧ください。
...
こちらは、[将来の機能計画](https://zerotrace.io/docs/about/milestone/?from=github)です。IssueやPull Requestを歓迎します。
